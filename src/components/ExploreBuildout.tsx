...
export default function ExploreBuildout({ showCompare = false, activity }: { showCompare?: boolean; activity: LayerActivity }) {
  ...
  return (
    <>
      <Navbar showCompare={showCompare} />
      <main className="flex-1">
        <section className="max-w-7xl mx-auto px-4 md:px-8 pt-12 pb-4">
          <p className="kicker mb-3">Explore the bigger story</p>
          <h1 className="text-4xl md:text-5xl font-extrabold mb-4">One building. An entire supply chain.</h1>
          <p className="max-w-2xl text-base leading-relaxed" style={{ color: "var(--text-dim)" }}>
            Follow the industries behind the AI buildout, from power and materials to chips and software.
            Select a layer to explore its companies, prices, and context.
          </p>
        </section>
