...
const {run,filings,notices,failures}=replayInstitutionRun(resolve(import.meta.dirname,"../data/institution-runs",runId));
const result=validateManagerCorpus(filings,failures,notices);
