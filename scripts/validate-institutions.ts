...
const {run,filings,notices,failures,reconciliationIssues}=replayInstitutionRun(resolve(import.meta.dirname,"../data/institution-runs",runId));
const result=validateManagerCorpus(filings,failures,notices,reconciliationIssues);
